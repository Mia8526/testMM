...
## 2026-07-24 — 趨勢分析加回聯動觀察日誌

- [x] 依 Grace 操作習慣，在趨勢分析最下方加回精簡版觀察日誌，方便直接切換並重新分析股票。
- [x] 保留五欄摘要、重新查詢與刪除；目前分析中的股票以淡藍底標示。
- [x] 完整日誌仍保留獨立頁，底部提供快速開啟按鈕。

## 2026-07-24 — 調整趨勢分析區塊順序

- [x] 將趨勢視覺化移至第三個區塊，2027／2028 目標價情境順延至第四個區塊。
- [x] 觀察日誌維持在整頁最下方，方便依序看完趨勢與估值後切換股票。

## 2026-07-29 — 6197 箱型規則修正

- [x] 現價低於箱底、但尚未符合3%與兩日確認時，改顯示「箱底失守觀察」，不再誤標支撐區。
- [x] 箱型寬度22%以下標為標準箱型，22%～30%改標「寬幅整理」。
- [x] 標準箱型首尾漂移上限收緊至12%，寬幅整理收緊至10%，降低單邊趨勢誤判。
- [x] 新增箱底失守與寬幅整理回歸測試，並以6197實際資料驗證。

## 2026-07-29 — 觀察日誌加入日期欄

- [x] 完整觀察日誌與趨勢分析底部聯動日誌新增獨立「加入日期」欄。
- [x] 日期不再藏在股票名稱下方，方便比較各持股加入時間。

## 2026-07-30 — 趨勢視覺化線圖整理

- [x] 股價改為深藍粗實線；MA50／150／200改用橘、青綠、紫色與不同線型。
